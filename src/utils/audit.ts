...
/**
 * @deprecated Use generateAuditHashAsync instead. This function uses a weak 32-bit hashing algorithm
 * prone to collisions and delimiter injection.
 */
...
/**
 * @deprecated Use createAuditLogAsync instead.
 */
